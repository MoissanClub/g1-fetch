...
| `*.onnx`, `*.engine` | ONNX + TensorRT 10.3 FP16 engines for the Orin NX (built on PC2 2026-09-26, ~8 min each; arch/TensorRT-version specific, rebuild after any TensorRT upgrade) | `scripts/export_detector.py --engine` |
